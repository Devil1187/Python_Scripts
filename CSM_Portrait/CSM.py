...
turtle.bgpic("Python_Scripts\CSM_Portrait\Hariom_Lokhandkar_A_photo-realistic_watercolor_painting_with_a_soft,_45bf4772-65f2-410b-96fb-c9be0a4d5cd5.png")

# setup size of marker & speed of painting

t.pensize(3)  # You can change the size of marker
t.speed(20)
